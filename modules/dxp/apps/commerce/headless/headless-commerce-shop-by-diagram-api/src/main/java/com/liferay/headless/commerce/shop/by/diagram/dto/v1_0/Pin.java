...
public class Pin implements Serializable {
	...
	@Schema
	@Valid
	public DiagramEntry getEntry() {
		return entry;
	}

	public void setEntry(DiagramEntry entry) {
		this.entry = entry;
	}

	@JsonIgnore
	public void setEntry(
		UnsafeSupplier<DiagramEntry, Exception> entryUnsafeSupplier) {

		try {
			entry = entryUnsafeSupplier.get();
		}
