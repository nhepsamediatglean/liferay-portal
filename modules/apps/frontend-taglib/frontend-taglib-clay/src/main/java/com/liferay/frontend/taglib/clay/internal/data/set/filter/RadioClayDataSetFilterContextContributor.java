...
import com.liferay.frontend.taglib.clay.data.set.filter.RadioClayDataSetFilter;
...
public class RadioClayDataSetFilterContextContributor
	...
	public Map<String, Object> getClayDataSetFilterContext(
		...
		if (clayDataSetFilter instanceof RadioClayDataSetFilter) {
			return _serialize(
				(RadioClayDataSetFilter)clayDataSetFilter, locale);
		}
	...
	private Map<String, Object> _serialize(
		RadioClayDataSetFilter radioClayDataSetFilter, Locale locale) {

		List<KeyValuePair> keyValuePairs =
			radioClayDataSetFilter.getKeyValuePairs(locale);
