...
public class AggregationsImpl implements Aggregations {
	...
	@Override
	public BucketScriptPipelineAggregation bucketScriptPipeline(
	...
	@Override
	public BucketSelectorPipelineAggregation bucketSelectorPipeline(
		String name, Script script) {
	...
	@Override
	public MovingFunctionPipelineAggregation movingFunctionPipeline(
