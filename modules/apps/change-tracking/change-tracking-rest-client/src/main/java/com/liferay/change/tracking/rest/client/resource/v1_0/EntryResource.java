...
public interface EntryResource {
	...
	public HttpInvoker.HttpResponse getCollectionEntryHttpResponse(
	...
	public static class EntryResourceImpl implements EntryResource {
		...
		public Entry getCollectionEntry(Long collectionId, Long entryId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getCollectionEntryHttpResponse(collectionId, entryId);
		...
		public HttpInvoker.HttpResponse getCollectionEntryHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/change-tracking/v1.0/collections/{collectionId}/entries/{entryId}",
