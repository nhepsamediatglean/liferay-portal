...
public interface AffectedEntryResource {
	...
	public HttpInvoker.HttpResponse getCollectionEntryAffectedsPageHttpResponse(
			Long collectionId, Long entryId, String keywords,
			Pagination pagination)
		throws Exception;
	...
	public static class AffectedEntryResourceImpl
		...
		public Page<AffectedEntry> getCollectionEntryAffectedsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getCollectionEntryAffectedsPageHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/change-tracking/v1.0/collections/{collectionId}/entries/{entryId}/affecteds",
