...
package com.liferay.commerce.payment.method.remote.internal.servlet;
...
@Component(
	...
	property = {
		"osgi.http.whiteboard.context.path=/" + RemoteCommercePaymentMethodConstants.SERVLET_PATH,
		"osgi.http.whiteboard.servlet.name=com.liferay.commerce.payment.method.remote.internal.servlet.RemoteCommercePaymentMethodServlet",
		"osgi.http.whiteboard.servlet.pattern=/" + RemoteCommercePaymentMethodConstants.SERVLET_PATH + "/*"
	},
	service = Servlet.class
)
public class RemoteCommercePaymentMethodServlet extends HttpServlet {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RemoteCommercePaymentMethodServlet.class);
