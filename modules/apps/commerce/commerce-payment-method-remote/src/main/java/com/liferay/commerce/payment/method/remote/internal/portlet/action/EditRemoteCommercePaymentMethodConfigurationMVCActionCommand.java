...
package com.liferay.commerce.payment.method.remote.internal.portlet.action;
...
public class EditRemoteCommercePaymentMethodConfigurationMVCActionCommand
	...
	protected void doProcessAction(
		...
		UnicodeProperties engineParameterUnicodeProperties =
			PropertiesParamUtil.getProperties(actionRequest, "settings--");

		for (Map.Entry<String, String> entry :
				engineParameterUnicodeProperties.entrySet()) {
