...
public class LayoutVersionPersistenceImpl
	 ...
	 */
	@Override
	public List<LayoutVersion> findByG_P_GtLP_LtRP(
	...
	public LayoutVersion findByG_P_GtLP_LtRP_First(
		...
		LayoutVersion layoutVersion = fetchByG_P_GtLP_LtRP_First(
	...
	public LayoutVersion fetchByG_P_GtLP_LtRP_First(
		...
		List<LayoutVersion> list = findByG_P_GtLP_LtRP(
	...
	public LayoutVersion findByG_P_GtLP_LtRP_Last(
		...
		LayoutVersion layoutVersion = fetchByG_P_GtLP_LtRP_Last(
			groupId, leftPlid, rightPlid, privateLayout, orderByComparator);
	...
	public LayoutVersion[] findByG_P_GtLP_LtRP_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_P_GtLP_LtRP_PrevAndNext(
				session, layoutVersion, groupId, leftPlid, rightPlid,
	...
	protected LayoutVersion getByG_P_GtLP_LtRP_PrevAndNext(
		Session session, LayoutVersion layoutVersion, long groupId,
	 ...
	 */
	@Override
	public List<LayoutVersion> findByG_P_GtLP_LtRP_Version(
		long groupId, long leftPlid, long rightPlid, boolean privateLayout,
		int version) {

		return findByG_P_GtLP_LtRP_Version(
	...
	public List<LayoutVersion> findByG_P_GtLP_LtRP_Version(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath =
				_finderPathWithoutPaginationFindByG_P_GtLP_LtRP_Version;
			finderArgs = new Object[] {
				groupId, leftPlid, rightPlid, privateLayout, version
			};
		}
			...
			finderArgs = new Object[] {
				groupId, leftPlid, rightPlid, privateLayout, version, start,
	...
	public LayoutVersion findByG_P_GtLP_LtRP_Version_First(
		...
		LayoutVersion layoutVersion = fetchByG_P_GtLP_LtRP_Version_First(
			groupId, leftPlid, rightPlid, privateLayout, version,
			orderByComparator);
	...
	public LayoutVersion fetchByG_P_GtLP_LtRP_Version_First(
		...
		List<LayoutVersion> list = findByG_P_GtLP_LtRP_Version(
			groupId, leftPlid, rightPlid, privateLayout, version, 0, 1,
			orderByComparator);
	...
	public LayoutVersion findByG_P_GtLP_LtRP_Version_Last(
		...
		LayoutVersion layoutVersion = fetchByG_P_GtLP_LtRP_Version_Last(
			groupId, leftPlid, rightPlid, privateLayout, version,
			orderByComparator);
	...
	public LayoutVersion fetchByG_P_GtLP_LtRP_Version_Last(
		...
		int count = countByG_P_GtLP_LtRP_Version(
			groupId, leftPlid, rightPlid, privateLayout, version);
		...
		List<LayoutVersion> list = findByG_P_GtLP_LtRP_Version(
			groupId, leftPlid, rightPlid, privateLayout, version, count - 1,
	...
	public LayoutVersion[] findByG_P_GtLP_LtRP_Version_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_P_GtLP_LtRP_Version_PrevAndNext(
				session, layoutVersion, groupId, leftPlid, rightPlid,
				privateLayout, version, orderByComparator, true);

			array[1] = layoutVersion;

			array[2] = getByG_P_GtLP_LtRP_Version_PrevAndNext(
				session, layoutVersion, groupId, leftPlid, rightPlid,
				privateLayout, version, orderByComparator, false);
	...
	private static final String _FINDER_COLUMN_G_P_GTLP_LTRP_VERSION_GROUPID_2 =
		"layoutVersion.groupId = ? AND ";

	private static final String
		_FINDER_COLUMN_G_P_GTLP_LTRP_VERSION_LEFTPLID_2 =
			"layoutVersion.leftPlid = ? AND ";

	private static final String
		_FINDER_COLUMN_G_P_GTLP_LTRP_VERSION_RIGHTPLID_2 =
			"layoutVersion.rightPlid = ? AND ";

	private static final String
		_FINDER_COLUMN_G_P_GTLP_LTRP_VERSION_PRIVATELAYOUT_2 =
			"layoutVersion.privateLayout = ? AND ";

	private static final String _FINDER_COLUMN_G_P_GTLP_LTRP_VERSION_VERSION_2 =
		"layoutVersion.version = ?";
	...
	public LayoutVersion updateImpl(LayoutVersion layoutVersion) {
		...
		if (!LayoutVersionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			FinderCacheUtil.removeResult(
				_finderPathWithoutPaginationFindByG_P_GtLP_LtRP, args);
			...
			FinderCacheUtil.removeResult(
				_finderPathCountByG_P_GtLP_LtRP_Version, args);
			FinderCacheUtil.removeResult(
				_finderPathWithoutPaginationFindByG_P_GtLP_LtRP_Version, args);
			...
			if ((layoutVersionModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByG_P_GtLP_LtRP.
					 getColumnBitmask()) != 0) {
				...
				FinderCacheUtil.removeResult(
					_finderPathCountByG_P_GtLP_LtRP, args);
				FinderCacheUtil.removeResult(
					_finderPathWithoutPaginationFindByG_P_GtLP_LtRP, args);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByG_P_GtLP_LtRP = new FinderPath(
			LayoutVersionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutVersionModelImpl.FINDER_CACHE_ENABLED,
			LayoutVersionImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_P_GtLP_LtRP",
		...
		_finderPathCountByG_P_GtLP_LtRP = new FinderPath(
			LayoutVersionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationFindByG_P_GtLP_LtRP_Version = new FinderPath(
			LayoutVersionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutVersionModelImpl.FINDER_CACHE_ENABLED,
			LayoutVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_P_GtLP_LtRP_Version",
		...
		_finderPathCountByG_P_GtLP_LtRP_Version = new FinderPath(
			LayoutVersionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
